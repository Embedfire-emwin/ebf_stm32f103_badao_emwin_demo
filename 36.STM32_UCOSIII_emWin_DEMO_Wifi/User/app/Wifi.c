...
static uint8_t wifi_buffer[BUFFER_SIZE];				                              	          /*定义一个2KB的缓存*/
    ...
    case GUI_ID_BUTTON1: // Notifications sent by 'Send'
      ...
      case WM_NOTIFICATION_RELEASED:
        // USER START (Optionally insert code for reacting on notification message)
				...
				MULTIEDIT_GetText(WM_GetDialogItem(pMsg->hWin, GUI_ID_MULTIEDIT0),(char *)wifi_buffer,BUFFER_SIZE);
				utf82gbk((const char *)wifi_buffer,(char *)wifi_buffer);
				ESP8266_SendString(ENABLE,(char *)wifi_buffer,0, Single_ID_0 ); 
