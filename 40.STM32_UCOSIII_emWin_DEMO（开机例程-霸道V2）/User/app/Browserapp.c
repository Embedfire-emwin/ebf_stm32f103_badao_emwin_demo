...
static void OpenFileProcess(int sel_num,char* record_file)
{
	...
	{				
		//GUI_MessageBox("\r\n Sorry,do not support open the file! \r\n","Sorry",GUI_MESSAGEBOX_CF_MOVEABLE);
		GUI_ExecCreatedDialog(MESSAGEBOX_Create("\r\n Sorry,do not support open the file! \r\n","Sorry",GUI_MESSAGEBOX_CF_MODAL));
	}
...
void FUN_ICON203Clicked(void)
{
	...
	while(Flag_ICON203)
	{
		if(tpad_flag)WM_DeleteWindow(hDialog);
		GUI_Delay(10); 
	}
}
