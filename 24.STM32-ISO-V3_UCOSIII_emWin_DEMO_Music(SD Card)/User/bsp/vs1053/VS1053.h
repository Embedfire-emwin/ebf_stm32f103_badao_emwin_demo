...
#define VS_GPIO_PORT					GPIOB									/* GPIO端口 */
#define VS_GPIO_CLK						RCC_APB2Periph_GPIOB					/* GPIO端口时钟 */
#define VS_RST								GPIO_Pin_9								/*定义VS1053的RST管脚*/
#define VS_DREQ								GPIO_Pin_8								/*定义VS1053的DREQ管脚*/
